...
function login_form_submit() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            localStorage.setItem('userName', $accountl.val())
            localStorage.setItem('tokenCreateTime', data.createTime)
            $.cookie('token', data.token)
            $.cookie('userName', $accountl.val())
            $.cookie('tokenCreateTime', data.createTime)
