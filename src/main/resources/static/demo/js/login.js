...
function login_form_submit(){
    var $jsLoginBtn = $('#jsLoginBtn'),
        ...
        [
            {id: '#userName', tips: Dml.Msg.epUserName, errorTips: Dml.Msg.erUserName, regName: 'phMail', require: true},
            {id: '#password', tips: Dml.Msg.epPwd, errorTips: Dml.Msg.erPwd, regName: 'pwd', require: true}
        ]
    );
    if(!verify){
       return;
